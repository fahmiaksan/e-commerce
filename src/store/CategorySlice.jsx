...
export const fetchProductsByCategory = (categoryID, dataType) => {
    return async function fetchCategoryProductThunk(dispatch) {
        dataType === 'all' && dispatch(setCategoriesStatusAll(STATUS.LOADING));
        dataType === 'single' && dispatch(setCategoriesStatusSingle(STATUS.LOADING));
        ...
        try {
            ...
            dataType === "all" && dispatch(setCategoriesStatusAll(STATUS.ERROR));
            dataType === "single" && dispatch(setCategoriesStatusSingle(STATUS.ERROR));
        }
    }
}