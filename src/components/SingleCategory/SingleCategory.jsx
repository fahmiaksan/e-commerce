...
export default function SingleCategory({ products, status }) {
        ...
        <section className='pt-16'>
            ...
            <div>
                <div className='lg:px-28 sm:px-16 hp:px-12 pt-10'>
                    <div>
                        <h3 className='font-bold md:text-2xl hp:text-xl text-blue-950 tracking-wider'>{products[0].category.name}</h3>
                    </div>
